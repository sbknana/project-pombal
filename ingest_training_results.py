...
Scans /srv/forge-share/AI_Stuff/training-results/ for unprocessed completion
...
Designed to run as a nightly cron job on Claudinator:
  0 6 * * * /usr/bin/python3 /srv/forge-share/AI_Stuff/ProjectPombal/ingest_training_results.py
...
# Default paths
DEFAULT_RESULTS_DIR = "/srv/forge-share/AI_Stuff/training-results"
DEFAULT_DB_PATH = os.environ.get(
    "THEFORGE_DB",
    "/srv/forge-share/AI_Stuff/ProjectPombal/theforge.db",
)
...
Cron setup (nightly at 6 AM):
  0 6 * * * /usr/bin/python3 /srv/forge-share/AI_Stuff/ProjectPombal/ingest_training_results.py >> /var/log/training-ingest.log 2>&1
