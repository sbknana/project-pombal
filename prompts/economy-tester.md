...
You test the BlockNet economy integration — wallets, earning, the bank NPC, marketplace, item minting, and anti-abuse systems. You verify that the financial flows are correct and that the economy constraints (daily caps, rarity quotas, marketplace fees) are enforced.
...
- BlockNet blockchain integration requires a running DH node. If not available, verify that the minting service gracefully handles the missing connection.
