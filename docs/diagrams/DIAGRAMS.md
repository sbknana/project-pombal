# Equipa-repo - Architecture Diagrams

Generated by Athena v1.0.0 on 2026-03-28T07:54:50.596Z
...
```mermaid
graph TD
  srv_forge_share_AI_Stuff_Equipa_repo["Equipa-repo (31)"]:::dir
  srv_forge_share_AI_Stuff_Equipa_repo_docs["docs (14)"]:::dir
  ...
  srv_forge_share_AI_Stuff_Equipa_repo_prompts_more["16 more files"]:::meta
  ...
  srv_forge_share_AI_Stuff_Equipa_repo_skills_tester["tester (1)"]:::dir
  srv_forge_share_AI_Stuff_Equipa_repo_skills --> srv_forge_share_AI_Stuff_Equipa_repo_skills_tester
  srv_forge_share_AI_Stuff_Equipa_repo_skills_tester_skills["skills"]:::dir
  srv_forge_share_AI_Stuff_Equipa_repo_skills_tester --> srv_forge_share_AI_Stuff_Equipa_repo_skills_tester_skills
  srv_forge_share_AI_Stuff_Equipa_repo_skills_tester_README_md["README.md"]:::file
  srv_forge_share_AI_Stuff_Equipa_repo_skills_tester --> srv_forge_share_AI_Stuff_Equipa_repo_skills_tester_README_md
  srv_forge_share_AI_Stuff_Equipa_repo_task_outputs["task-outputs (34)"]:::dir
  srv_forge_share_AI_Stuff_Equipa_repo --> srv_forge_share_AI_Stuff_Equipa_repo_task_outputs
  srv_forge_share_AI_Stuff_Equipa_repo_task_outputs_more["34 more files"]:::meta
  srv_forge_share_AI_Stuff_Equipa_repo_task_outputs --> srv_forge_share_AI_Stuff_Equipa_repo_task_outputs_more
  srv_forge_share_AI_Stuff_Equipa_repo_tests["tests (29)"]:::dir
  srv_forge_share_AI_Stuff_Equipa_repo --> srv_forge_share_AI_Stuff_Equipa_repo_tests
  srv_forge_share_AI_Stuff_Equipa_repo_tests_more["29 more files"]:::meta
  srv_forge_share_AI_Stuff_Equipa_repo_tests --> srv_forge_share_AI_Stuff_Equipa_repo_tests_more
  srv_forge_share_AI_Stuff_Equipa_repo_tools["tools (5)"]:::dir
  srv_forge_share_AI_Stuff_Equipa_repo --> srv_forge_share_AI_Stuff_Equipa_repo_tools
  srv_forge_share_AI_Stuff_Equipa_repo_tools_more["5 more files"]:::meta
  srv_forge_share_AI_Stuff_Equipa_repo_tools --> srv_forge_share_AI_Stuff_Equipa_repo_tools_more
  srv_forge_share_AI_Stuff_Equipa_repo_env_example[".env.example"]:::file
  srv_forge_share_AI_Stuff_Equipa_repo --> srv_forge_share_AI_Stuff_Equipa_repo_env_example
  srv_forge_share_AI_Stuff_Equipa_repo_CLAUDE_md["CLAUDE.md"]:::file
  srv_forge_share_AI_Stuff_Equipa_repo --> srv_forge_share_AI_Stuff_Equipa_repo_CLAUDE_md
