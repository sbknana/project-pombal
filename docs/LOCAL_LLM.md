...
Run ForgeTeam agents on local models via Ollama. No API key needed.
...
```bash
export OLLAMA_BASE_URL=http://192.168.0.5:11434
```
...
- **Forgeborn fine-tuned models** — QLoRA-trained on ForgeTeam task data for better role performance
