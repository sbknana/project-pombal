...
|---|---|---|---|
| `EQUIPA_DB` | Path to the SQLite database file | `/home/user/equipa/theforge.db` | No — auto-detected from config |
| `EQUIPA_BASE` | Base install directory | `/home/user/equipa` | No — set during setup |
...
0 */6 * * * cd /home/user/equipa && python3 forgesmith.py --auto >> /home/user/equipa/logs/forgesmith.log 2>&1

# Run SIMBA rule generation weekly
0 3 * * 0 cd /home/user/equipa && python3 forgesmith_simba.py >> /home/user/equipa/logs/simba.log 2>&1

# Nightly review report
0 22 * * * cd /home/user/equipa && python3 nightly_review.py >> /home/user/equipa/logs/nightly.log 2>&1

# Auto-dispatch pending work every 30 minutes
*/30 * * * * cd /home/user/equipa && python3 forge_orchestrator.py --dispatch >> /home/user/equipa/logs/dispatch.log 2>&1
```
