...
**Impact:** A local attacker with access to the shared `REDACTED_SHARE_PATH/` filesystem could exploit the predictable pytest temp directory to inject malicious content or perform privilege escalation when tests are run.
