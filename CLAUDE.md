...
**Why it exists:**
ForgeTeam is currently hardcoded to one developer's Google Drive paths, project mappings, and DB location. Itzamna extracts all of that into a portable, configurable system that anyone can install and use.
