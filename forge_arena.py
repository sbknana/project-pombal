...
# --- DOGE-HABEAS Go Blockchain Rewrite Phases ---
...
DOGE_HABEAS_PHASES = [
    {
        ...
        "developer_task": """Build the Go foundation for the DOGE-HABEAS blockchain.

**Context:** This is a complete rewrite of the Node.js DOGE-HABEAS blockchain in Go.
Target: 2500 TPS, 500ms block time, PoH+PoS consensus via CometBFT ABCI.

**Requirements:**
1. Go module: `github.com/forgeborn/doge-habeas`
...
""",
        "tester_task": """Write tests for the DOGE-HABEAS Go blockchain foundation.
...
""",
        "security_task": """Security review the DOGE-HABEAS blockchain foundation.
...
""",
        "review_task": """Code review the DOGE-HABEAS blockchain foundation.
...
""",
    },
    {
        ...
        "developer_task": """Implement the transaction engine for DOGE-HABEAS.
...
""",
        "tester_task": """Write comprehensive tests for the DOGE-HABEAS transaction engine.
...
""",
        "security_task": """Security review the DOGE-HABEAS transaction engine.
...
""",
        "review_task": """Code review the DOGE-HABEAS transaction engine.
...
""",
    },
    {
        ...
        "developer_task": """Implement PoH+PoS consensus for DOGE-HABEAS.
...
""",
        "tester_task": """Write tests for DOGE-HABEAS PoH+PoS consensus.
...
""",
        "security_task": """Security review DOGE-HABEAS consensus layer.
...
""",
        "review_task": """Code review DOGE-HABEAS consensus implementation.
...
""",
    },
    {
        ...
        "developer_task": """Implement P2P networking for DOGE-HABEAS using libp2p.
...
""",
        "tester_task": """Write tests for DOGE-HABEAS P2P networking.
...
**`go test ./... -race` must pass.**
""",
        "security_task": """Security review DOGE-HABEAS P2P layer.
...
""",
        "review_task": """Code review DOGE-HABEAS P2P networking.
...
""",
    },
    {
        ...
        "developer_task": """Implement the RPC API and CLI for DOGE-HABEAS.
...
""",
        "tester_task": """Write tests for DOGE-HABEAS RPC, CLI, and state channels.
...
**`go test ./... -race` must pass.**
""",
        "security_task": """Security review DOGE-HABEAS RPC, CLI, and state channels.
...
""",
        "review_task": """Code review DOGE-HABEAS RPC, CLI, and state channels.
...
""",
    },
    {
        ...
        "developer_task": """Performance-tune DOGE-HABEAS to hit 2500 TPS at 500ms blocks.
...
""",
        "tester_task": """Validate DOGE-HABEAS performance benchmarks.
...
""",
        "security_task": """Security review DOGE-HABEAS under load.
...
""",
        "review_task": """Code review DOGE-HABEAS performance optimizations.
