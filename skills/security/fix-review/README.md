...
### synced storage Integration

If a synced storage URL is provided and direct access fails:
...
- Optional: `gdrive` CLI for synced storage integration
  ```bash
