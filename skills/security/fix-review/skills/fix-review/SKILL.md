...
| Security report | No | Local path, URL, or synced storage link |
...
**synced storage URL that fails:**
See `references/report-parsing.md` for synced storage fallback logic using `gdrive` CLI.
